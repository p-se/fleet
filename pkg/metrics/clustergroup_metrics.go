...
func init() {
	...
	metrics.Registry.MustRegister(clusterGroupResourcesMissing)
	metrics.Registry.MustRegister(clusterGroupResourcesModified)
	metrics.Registry.MustRegister(clusterGroupResourcesNotReady)
	metrics.Registry.MustRegister(clusterGroupResourcesOrphaned)
	metrics.Registry.MustRegister(clusterGroupResourcesReady)
	metrics.Registry.MustRegister(clusterGroupResourcesUnknown)
	metrics.Registry.MustRegister(clusterGroupResourcesWaitApplied)
	metrics.Registry.MustRegister(clusterGroupDesiredReadyBundles)
	metrics.Registry.MustRegister(clusterGroupReadyBundles)
	metrics.Registry.MustRegister(clusterGroupObserved)
}
